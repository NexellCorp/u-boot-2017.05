...
struct n25q1024_area n25q1024_area[] = {
	{ 0,  0,    0,    0,    2048},
	{ 17, 0,    0,    1,    2047},
	{ 18, 0,    1,    2,    2047},
	{ 19, 0,    3,    4,    2047},
...
u8 convert_context_type(u8 val, enum context_type ctx_type)
{
...
int stm_n25q1024_is_locked(struct spi_flash *flash, u32 ofs, size_t len)
{
...
int stm_n25q1024_lock(struct spi_flash *flash, u32 ofs, size_t len)
{
	u8 status_new;
	u8 ctx = 0;
	int len_sector;
...
int stm_n25q1024_unlock(struct spi_flash *flash, u32 ofs, size_t len)
{
	u8 status_new;
	u8 ctx = 0;
